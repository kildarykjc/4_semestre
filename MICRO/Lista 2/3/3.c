...
void Inicializa_Lcd (void)
{
   ...
   Envia_Comando_Lcd (0b000000001); // 
    ...
    Envia_Comando_Lcd (0x40); // Lcd 4 bits
   
    Envia_Dado_Lcd (0b000000000);
    Envia_Dado_Lcd (0b000000000);
    Envia_Dado_Lcd (0b000000000);
    Envia_Dado_Lcd (0b000000111);
    Envia_Dado_Lcd (0b000001000);
    Envia_Dado_Lcd (0b000000111);
    Envia_Dado_Lcd (0b000000010);
    Envia_Dado_Lcd (0b000000100);
